  ...
  useEffect(() => {
    ...
    chrome.runtime.onMessage.addListener((request: MsgRes<keyof typeof ACTIONS, any>, sender, sendResponse) => {
      ...
      if (request.type === ACTIONS.GetPageContent) {
        ...
        const markdownContent = turndownService.turndown(request.payload.content);

        console.log('%c=contentjs onMessage EndOfGetPageContent parse markdownwn results:', 'color:yellow', { markdownContent })
      }
